...
class DB_Main extends DB_Primary {
    ...
    */
    public function insertIntoDatabase($tableName, $columnNames) {
    ...
    */
    public function generate2dArrayFromDB($tableName, $columnNames, $where) {
        //creates a connection with the Database
        $conn = $this->connect();
    ...
    /*******************************************************************************
        ...
        Varables input:
            ...
            $where(expects a string with a $where statement for the sql DB)
    */
    public function generateAssocArray($tableName, $columnNames, $where) {
    ...
    */
    public function updateDatabase($tableName, $set, $where) {
        //creates a connection with the Database
        $conn = $this->connect();
    ...
    /********************************************************
        ...
        Variables input:
            ...
            $where needs a prepared sql command as a string
    */
    public function deleteRecordInDatabase($tableName, $where) {
        //creates a connection with the Database
        $conn = $this->connect();
